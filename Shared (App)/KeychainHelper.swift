...
final class KeychainHelper {
    ...
    static func savePassword(password: Data, service: String, account: String) throws {
        ...
        if status == errSecDuplicateItem {
            throw KeychainInterface.KeychainError.duplicateItem
        }

        // Any status other than errSecSuccess indicates the
        // save operation failed.
        guard status == errSecSuccess else {
            throw KeychainInterface.KeychainError.unexpectedStatus(status)
        }
    }
    ...
    static func updatePassword(password: Data, service: String, account: String) throws {
        ...
        guard status != errSecItemNotFound else {
            throw KeychainInterface.KeychainError.itemNotFound
        }
